...
def resample_thematic(InputRefImagePath, input_LC_path, resample_method, label_mask, out_value):
    '''
    ...
    out_value : int
        number you want as output in the mask, such as 1 or 10
    ...
    wasdi.wasdiLog(f"GDAL Version: {gdal.VersionInfo()}")
    ...
    warped_mem_ds = gdal.Warp('', in_mem_ds, format='MEM',
                                  ...
                                  dstSRS=src_crs,  # No reprojection necessary as both CRS are the same
